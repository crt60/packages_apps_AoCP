...
public class CreateShortcut extends LauncherActivity {
    ...
    protected Intent getTargetIntent() {
        ...
        targetIntent.addCategory("com.collective.personalize.SHORTCUT");
    ...
    protected void onListItemClick(ListView l, View v, int position, long id) {
        ...
        shortcutIntent.setClass(getApplicationContext(), PersonalizeActivity.class);
        shortcutIntent.setAction("com.collective.personalize.START_NEW_FRAGMENT");
        shortcutIntent.putExtra("aocp_fragment_name", intentClass);
