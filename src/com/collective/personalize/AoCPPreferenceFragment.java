 ...
 */
public class AoCPPreferenceFragment extends PreferenceFragment implements DialogCreatable {
    ...
    public static class SettingsDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(Bundle savedInstanceState) {
            if (savedInstanceState != null) {
                ...
                if (mParentFragment instanceof AoCPPreferenceFragment) {
                    // restore mDialogFragment in mParentFragment
                    ((AoCPPreferenceFragment) mParentFragment).mDialogFragment = this;
                }
            }
        ...
        public void onDetach() {
            ...
            if (mParentFragment instanceof AoCPPreferenceFragment) {
                ...
                if (((AoCPPreferenceFragment) mParentFragment).mDialogFragment == this) {
                    ((AoCPPreferenceFragment) mParentFragment).mDialogFragment = null;
                }
            }
        }
    }
