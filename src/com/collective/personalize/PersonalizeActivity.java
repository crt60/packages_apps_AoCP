...
import com.collective.personalize.service.BootService;
...
public class PersonalizeActivity extends PreferenceActivity implements ButtonBarHandler {

    private static final String TAG = "AoCP";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if ("com.collective.personalize.START_NEW_FRAGMENT".equals(getIntent().getAction())) {
            String className = getIntent().getStringExtra("aocp_fragment_name").toString();
            Class<?> cls = null;
            try {
            ...
            try {
                cls.asSubclass(PersonalizeActivity.class);
                return;
